...
// HTTP behaviour is covered in smithsonian_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "smithsonian://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("smithsonian", "about")
	if err != nil || got.String() != "smithsonian://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want smithsonian://page/about", got.String(), err)
	}
}
