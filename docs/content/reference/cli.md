...
```
smithsonian <command> [arguments] [flags]
```

Run `smithsonian <command> --help` for the full flag list on any command. This
...
per operation you declare in `smithsonian/domain.go`.
